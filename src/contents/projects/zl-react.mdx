...
- **Current site/version:** docs list **v0.7.4**.
- **JSR package:** 100% score; built & signed via Actions; multi-runtime support; \~one direct dependency (per package page).
- **Archival:** version snapshots on Zenodo for citation in papers/portfolio.
