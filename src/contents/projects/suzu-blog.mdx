...
- **Minimal JS at rest** → the template favors content over interactivity unless explicitly requested in a post/page.
  (Your portfolio can insert real Lighthouse/CI screenshots here.)
